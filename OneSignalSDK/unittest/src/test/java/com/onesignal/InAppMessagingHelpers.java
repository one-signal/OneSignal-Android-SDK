...
public class InAppMessagingHelpers {
    ...
    public static OSTestInAppMessage buildTestMessageWithTriggerAndRedisplay(final OSTriggerKind kind, final String key,
                                                                             final String operator, final Object value,
                                                                             final int limit, final long delay) throws JSONException {
