...
class OSInAppMessageController implements OSDynamicTriggerControllerObserver, OSSystemConditionController.OSSystemConditionObserver {
    ...
    private void showInformativeAlert(final String messageTitle, final String message, final OSInAppMessage inAppMessage, final List<OSInAppMessagePrompt> prompts) {
