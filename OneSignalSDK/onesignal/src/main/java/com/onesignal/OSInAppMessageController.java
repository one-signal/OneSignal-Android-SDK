...
class OSInAppMessageController implements OSDynamicTriggerControllerObserver, OSSystemConditionController.OSSystemConditionObserver {
     ...
     *
     * If trigger key is part of message trigger then set to true triggerChanged flag
     * */
     ...
     * Part of redisplay logic
     *
     * Only messages that have redisplay enable, they were already displayed and trigger changed can be redisplay
     * */
